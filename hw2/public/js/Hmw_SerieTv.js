fetch('Favorites/Serie').then(onResponce).then(onPrefer);
...
fetch("ApiController/Series/game+of+thrones").then(onResponce).then(onSearch);
fetch("ApiController/Series/breaking+bad").then(onResponce).then(onSearch);
fetch("ApiController/Series/lost").then(onResponce).then(onSearch);
fetch("ApiController/Series/ozark").then(onResponce).then(onSearch);
fetch("ApiController/Series/away").then(onResponce).then(onSearch);
fetch("ApiController/Series/rain").then(onResponce).then(onSearch);
fetch("ApiController/Series/la+casa+de+papel").then(onResponce).then(onSearch);
...
function search(event)
{
    ...
    else
    {
        ...
        fetch("ApiController/Series/"+link).then(onResponce).then(onSearch);
   ...
   function onSearch(json)
{
  ...
  for(let i=0;i<json.Search.length;i++){
   ...
   {   
       ...
       fetch("ApiController/Seriet/"+title).then(onResponce).then(onMore);
...
function add(event){
   ...
   fetch('Favorites/Serie/Add/'+titletarget).then(onRes);
...
function onComment(event){
    ...
    fetch('CommentController/SerieComment/'+get).then(onResponce).then(CommentJson);
}
...
function onPrefer(json){
    ...
    for(let i=0;i<json.length;i++){
        ...
        fetch("ApiController/Seriet/"+uri).then(onResponce).then(Prefe);
    }
    }
    else{
